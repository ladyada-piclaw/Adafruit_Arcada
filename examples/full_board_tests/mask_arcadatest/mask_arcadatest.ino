...
void setup(void) {
  ...
  if (!Arcada_QSPI_Flash.begin()) {
    ...
    arcada.display2->println(jedec, HEX);
  }
...
void loop() {
  ...
  arcada.display2->print("X:");
  arcada.display2->print(event.acceleration.x, 1);
  arcada.display->print(" Y:");
  arcada.display->print(event.acceleration.y, 1);
  arcada.display2->print(" Y:");
  arcada.display2->print(event.acceleration.y, 1);
  arcada.display->print(" Z:");
  arcada.display->print(event.acceleration.z, 1);
  arcada.display2->print(" Z:");
  arcada.display2->print(event.acceleration.z, 1);
  ...
  arcada.display->println(lite);
  arcada.display2->print("Light: ");
  arcada.display2->println(lite);
  ...
  Serial.print(vbat);
  Serial.println("V");
  arcada.display->print("Power: ");
  arcada.display->print(vbat);
  arcada.display->println("V");
  arcada.display2->print("Power: ");
  arcada.display2->print(vbat);
  arcada.display2->println("V");
  ...
  Serial.print("D2 Sensor: ");
  Serial.print(vsense);
  Serial.println("V");
  arcada.display->print("D2 Sensor: ");
  arcada.display->print(vsense);
  arcada.display->println("V");
  arcada.display2->print("D2 Sensor: ");
  arcada.display2->print(vsense);
  arcada.display2->println("V");
  vsense = analogRead(A3) * 3.3 / 1024;
  Serial.print("D3 Sensor: ");
  Serial.print(vsense);
  Serial.println("V");
  arcada.display->print("D3 Sensor: ");
  arcada.display->print(vsense);
  arcada.display->println("V");
  arcada.display2->print("D3 Sensor: ");
  arcada.display2->print(vsense);
  arcada.display2->println("V");
  ...
  for (int a = 0; a < 127; a++) {
    if (i2c_scan(a)) {
      ...
      arcada.display->print("0x");
      arcada.display->print(a, HEX);
      arcada.display->print(", ");
      arcada.display2->print("0x");
      arcada.display2->print(a, HEX);
      arcada.display2->print(", ");
    }
  }
}
