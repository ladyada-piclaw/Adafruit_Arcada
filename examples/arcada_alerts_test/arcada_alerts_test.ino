...
void setup() {
  ...
  arcada.infoBox(
      "Arcada alerts test! This is an info box with many lines of text?");

  arcada.display->fillScreen(ARCADA_GREEN);
  arcada.warnBox("Arcada alerts test! This is an warning box ... watch out!",
                 ARCADA_BUTTONMASK_B);

  arcada.display->fillScreen(ARCADA_BLUE);
  arcada.errorBox(
      "Arcada alerts test! This is an error box, something went wrong!",
